...
class Settings:
    ...
    # --- layout -----------------------------------------------------------------
    columns: str = "auto"               # auto = split at a clear gutter (magazines, reports);
                                        # "1" = always one column, as photographed books are
    column_min_gap: float = 1.0         # a gutter is at least this × median line height wide…
    column_min_lines: int = 3           # …with this many lines centred on either side…
    column_max_cross: float = 0.2       # …crossed by at most this share of the text (a headline)
